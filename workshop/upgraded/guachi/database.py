...
class dbdict(dict):
    ...
    def __setitem__(self, key, item):
        try:
            ...
            # Check if it's a type error or closed database error
            if "type" in str(e).lower() and "not supported" in str(e):
                # This is a type error, convert to InterfaceError for backward compatibility
                raise sqlite3.InterfaceError(str(e))
            else:
                # This is likely a closed database error, re-raise as is
                raise
